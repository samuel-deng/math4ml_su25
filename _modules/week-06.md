...
: This wasn't covered in class; [YouTube link here for mini-lecture](https://youtu.be/lTS62J8cKR8).
...
: Lecture 6.2: Under another paradigm for machine learning (maximum likelihood estimation), the [OLS estimator corresponds to MLE on the Gaussian error model]({{ site.baseurl }}/assets/figs/OLS_MLE1.png).

GD (Story thus far)
: Lecture 6.1: Closed the story of gradient descent by defining [*stochastic gradient descent*]({{ site.baseurl }}/assets/figs/sgd_batch1.html), where we use unbiased estimators of the gradient instead of the full gradient over all the data. 